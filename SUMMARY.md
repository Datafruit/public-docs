...
* [开发者文档](developer/README.md)
  * [WEB SDK 使用文档](developer/web/README.md)
    ...
    * [整合JS SDK至web 环境](developer/web/integration.md)
    * [异步载入](developer/web/import-sdk.md)
    * [init参数配置](developer/web/init-sdk.md)
    * [事件公共属性\(超级属性\)](developer/web/super-props.md)
    * [预置属性](developer/web/dimensions.md)
    * [维度映射](developer/web/custom-dimensions.md)
    * [页面停留事件](developer/web/duration.md)
